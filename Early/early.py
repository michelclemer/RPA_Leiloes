...
def early_info():
    ...
    site = EARLY(driver)
    url = 'https://auth.bstock.com/oauth2/authorize?client_id=1b094c5f-c8a6-416c-8c62-4dc77ca88ce9&redirect_uri=https%3A%2F%2Fbstock.com%2Fearlyupgrade%2Fsso%2Findex%2Flogin%2F&scope=offline_access&response_type=code&state=isHome&mp_logo=https%3A%2F%2Fbstock.com%2Fearlyupgrade%2Fskin%2Ffrontend%2Fbstock%2Fauction%2Fimages%2Flogo.png&site_abb=eup&_ga=2.107838402.1794073461.1627852184-598900122.1623332325'
    json_data = {}
    data_ = {}
    driver.get(url)
    site.run_find_write((By.ID, ''), '')
    site.run_find_write((By.ID, ''), '')
