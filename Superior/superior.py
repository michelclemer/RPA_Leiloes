...
def superior():
    ...
    site = EARLY(driver)
    url = 'https://auth.bstock.com/oauth2/authorize?client_id=1b094c5f-c8a6-416c-8c62-4dc77ca88ce9&redirect_uri=https%3A%2F%2Fbstock.com%2Fsuperior%2Fsso%2Findex%2Flogin%2F&scope=offline_access&response_type=code&state=isRedirect&mp_logo=https%3A%2F%2Fbstock.com%2Fsuperior%2Fskin%2Ffrontend%2Fbstock%2Fauction%2Fimages%2Flogo.png&site_abb=tmb'
    json_data = {}
    data_ = {}
    driver.get(url)
    ...
    time.sleep(2)
    driver.get('https://bstock.com/superior/cell-phones/')
